...
- (void) connection:(NSURLConnection *)connection didFailWithError:(NSError *)error 
{
    ...
    UIAlertView *alert=[[UIAlertView alloc] initWithTitle:@"接收資料發生錯誤" message:@"Websocket handshake failed :(\nThe request timed out. \n請重新檢查網路連線及設定" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
    [alert show];
    _isConnected = NO;
    _isConnecting = NO;
